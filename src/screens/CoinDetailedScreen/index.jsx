          ...
          <ScrollView style={{ paddingHorizontal: 10 }}>
            <View style={styles.priceContainer}>
              <View style={styles.titleContainer}>
                <Image source={{ uri: small }} style={{ width: 40, height: 40, borderRadius: 100 }} />
                <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 6 }}>
                  <Text style={styles.name}>{name}</Text>
                  <Text style={{ color: '#fff' }}>{symbol.toUpperCase()}</Text>
                </View>
              </View>
              <View>
                <LineChart.PriceText
            ...
            <Text style={[styles.valueStatus, { fontSize: 16, marginBottom: 8, marginTop: 10 }]}>Keystatus</Text>
            <View style={styles.statusContainer}>
              <View style={styles.keyStatus}>
                <Text style={styles.titleStatus}>{name} Price</Text>
                <LineChart.PriceText
                  format={formatCurrency}
                  style={styles.valueStatus}
                />
              </View>
              <View style={{ backgroundColor: 'rgba(58,58,71,0.5)', height: 1, marginTop: 8, marginBottom: 8 }}>
              </View>
              <View style={styles.keyStatus}>
                <Text style={styles.titleStatus}>24h Low / 24h High</Text>
              ...
              <View style={styles.keyStatus}>
                <Text style={styles.titleStatus}>Total Volume</Text>
                <Text style={styles.valueStatus}>
                  ${total_volume.usd}
                </Text>
              </View>
              ...
              <View style={styles.keyStatus}>
                <Text style={styles.titleStatus}>Market Cap Rank</Text>
                <Text style={styles.valueStatus}>
                  #{market_cap_rank}
                </Text>
              </View>
              ...
              <View style={styles.keyStatus}>
                <Text style={styles.titleStatus}>Market Cap</Text>
                <Text style={styles.valueStatus}>
                  ${market_cap.usd}
                </Text>
              </View>
